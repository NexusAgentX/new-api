...
func TestDistributorRejectsSaturatedAffinityAndPreservesBinding(t *testing.T) {
	...
	_, found := service.GetPreferredChannelByAffinity(seedContext, "gpt-test", "default", priority)
	...
	preferredChannelID, found := service.GetPreferredChannelByAffinity(checkContext, "gpt-test", "default", priority)
