...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/metrics/overview", permission: authz.ChannelRead, handler: controller.GetChannelMetricsOverview},
	{method: http.MethodGet, path: "/metrics/dimensions", permission: authz.ChannelRead, handler: controller.GetChannelMetricDimensions},
	{method: http.MethodGet, path: "/metrics/runtime", permission: authz.ChannelRead, handler: controller.GetChannelMetricsRuntime},
	{method: http.MethodGet, path: "/metrics/:id", permission: authz.ChannelRead, handler: controller.GetChannelMetricsDetail},
